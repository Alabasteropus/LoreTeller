...
LoreTellerData_Vanilla = {}

function LoreTellerData_Vanilla:GetSoundPath(fileName, event)
    ...
    elseif Enums.SoundEvent.ZoneLore == event or Enums.SoundEvent.POILore == event then
        return format([[generated\sounds\zonelore\%s.mp3]], fileName)
    end
end

LoreTeller.DataModules:Register("LoreTellerData_Vanilla", LoreTellerData_Vanilla)

LoreTellerData_Vanilla.ZoneLoreData = {
