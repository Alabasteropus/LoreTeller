...
---@param event SoundEvent
---@return boolean isLoreEvent Is event related to zone or POI lore
function Enums.SoundEvent:IsLoreEvent(event)
    return event == self.ZoneLore or event == self.POILore
end
