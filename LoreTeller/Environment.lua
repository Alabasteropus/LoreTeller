...
2. Optionally retains the ability to access these "globals" via the only exposed global variable "LoreTeller"
...
setfenv(1, LoreTeller) must be added to every .lua file to allow it to work within this environment,
and this Environment file must be loaded before all others
]]

local _G = getfenv(0)
LoreTeller = setmetatable({ _G = _G }, { __index = _G })
