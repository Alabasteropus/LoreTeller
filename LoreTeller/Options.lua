            ...
            args = {
                MinimapButtonShow = {
                    ...
                    set = function(info, value)
                        ...
                        if value then
                            LibStub("LibDBIcon-1.0"):Show("LoreTeller")
                        else
                            LibStub("LibDBIcon-1.0"):Hide("LoreTeller")
                        end
                    end,
                },
                MinimapButtonLock = {
                    ...
                    set = function(info, value)
                        if value then
                            LibStub("LibDBIcon-1.0"):Lock("LoreTeller")
                        else
                            LibStub("LibDBIcon-1.0"):Unlock("LoreTeller")
                        end
                    end,
                },
        ...
        Frame = {
            ...
            args = {
                ...
                HideFrame = {
                    ...
                    order = 8,
                    name = "Hide Entirely",
                    desc = "Play LoreTellers without ever displaying the frame.",
                    disabled = false,
        ...
        Audio = {
            ...
            args = {
                SoundChannel = Version:IsRetailOrAboveLegacyVersion(40000) and {
                    ...
                    order = 1,
                    name = "Sound Channel",
                    desc = "Controls which sound channel LoreTeller will play in.",
                ...
                GossipFrequency = {
                    ...
                    desc = "Controls how often LoreTeller will play NPC greeting dialog.",
                    values = {
                ...
                AutoToggleDialog = (Version.IsLegacyVanilla or Version:IsRetailOrAboveLegacyVersion(60100) or nil) and {
                    ...
                    width = 2.25,
                    order = 4,
                    name = "Mute Vocal NPCs Greetings While LoreTeller is Playing",
                    desc = Version.IsLegacyVanilla and "Interrupts generic NPC greeting voicelines upon interacting with them if a LoreTeller will start playing." or "While LoreTeller is playing, the Dialog channel will be muted.",
                ...
                ToggleSyncToWindowState = {
                    ...
                    desc = "LoreTeller dialog will automatically stop when the gossip/quest window is closed.",
...
local ZoneLoreTab =
{
    ...
    args = {
        Description = {
            type = "description",
            order = 1,
            name = "Configure zone lore LoreTellers that play when entering zones or discovering points of interest.",
        },
        Settings = {
            type = "group",
            order = 2,
            ...
            args = {
                Enabled = {
                    type = "toggle",
                    order = 1,
                    name = "Enable Zone Lore LoreTellers",
                    desc = "Play LoreTellers when entering zones or discovering points of interest.",
                    get = function(info) return Addon.db.profile.ZoneLore.Enabled end,
                    set = function(info, value) Addon.db.profile.ZoneLore.Enabled = value end,
                },
                POIRadius = {
                    type = "range",
                    order = 2,
                    name = "POI Discovery Radius",
                    desc = "Distance in yards to trigger point of interest lore.",
                    min = 25,
                    max = 100,
                    step = 5,
                    get = function(info) return Addon.db.profile.ZoneLore.POIRadius end,
                    set = function(info, value) Addon.db.profile.ZoneLore.POIRadius = value end,
                },
                ShowInQuestLog = {
                    type = "toggle",
                    order = 3,
                    name = "Show in Quest Log",
                    desc = "Display discovered lore entries in the quest log.",
                    get = function(info) return Addon.db.profile.ZoneLore.ShowInQuestLog end,
                    set = function(info, value) Addon.db.profile.ZoneLore.ShowInQuestLog = value end,
                },
            }
        },
        Actions = {
            ...
            args = {
                ResetDiscovery = {
                    type = "execute",
                    order = 1,
                    name = "Reset Discovered Lore",
                    desc = "Clear all discovered zones and POIs for this character.",
                    func = function()
                        Addon.db.char.discoveredLore = { zones = {}, pois = {} }
                        Debug:Print("Discovered lore has been reset.", "ZoneLore")
                    end,
                },
            }
        }
...
local LegacyWrathTab = (Version.IsLegacyWrath or Version.IsLegacyBurningCrusade or nil) and {
    ...
    args = {
        PlayOnMusicChannel = {
            type = "group",
            order = 100,
            name = "Play LoreTellers on Music Channel",
            inline = true,
            args = {
                Description = {
                    type = "description",
                    order = 100,
                    name = format("%s client lacks the ability to stop addon sounds at will. As a workaround, you can play the LoreTellers on the music channel instead, which, unlike sounds, can be stopped. Regular background music will not be playing throughout the duration of LoreTellers.|n|nIf you normally play with music disabled - it will be temporarily enabled during LoreTellers, but no actual background music will be played.", Version.IsLegacyBurningCrusade and "2.4.3" or "3.3.5"),
                },
                Enabled = {
                    type = "toggle",
                    order = 200,
                ...
                Disabled = {
                    type = "description",
                    order = 300,
                    name = format("With this option disabled you %swill not be able to pause|r LoreTellers after they start playing. Attempting to pause will instead %1$spause the LoreTeller queue|r once the current sound has finished playing.", RED_FONT_COLOR_CODE),
                ...
                Settings = {
                    ...
                    args = {
                        FadeOutMusic = {
                            ...
                            desc = "Background music will fade out over this number of seconds before playing LoreTellers. Has no effect if in-game music is disabled or muted.",
                            min = 0,
                            softMax = 2,
                            bigStep = 0.05,
                        ...
                        Volume = {
                            type = "range",
                            order = 200,
                            name = "LoreTeller Volume",
                            desc = "Music channel volume will be temporarily adjusted to this value while the LoreTellers are playing.",
                            min = 0,
                            max = 1,
                            bigStep = 0.01,
                            isPercent = true,
...
local SlashCommands = {
    ...
    args = {
        ...
        Play = {
            ...
            order = 2,
            name = "Play Audio",
            desc = "Resume the playback of LoreTellers",
            func = function(info)
        ...
        Pause = {
            ...
            order = 3,
            name = "Pause Audio",
            desc = "Pause the playback of LoreTellers",
            func = function(info)
        ...
        Skip = {
            ...
            order = 4,
            name = "Skip Line",
            desc = "Skip the currently played LoreTeller",
            func = function(info)
        ...
        Clear = {
            ...
            order = 5,
            name = "Clear Queue",
            desc = "Stop the playback and clears the LoreTellers queue",
            func = function(info)
    ...
    DataModulesTab.args[module.AddonName] = {
        name = function()
            ...
            return format("%d. %s%s%s|r",
                ...
                string.gsub(module.Title, "LoreTeller Data %- ", ""),
        ...
        args = {
            ...
            Load = {
                ...
                func = function()
                    ...
                    if not loaded then
                        StaticPopup_Show("LoreTeller_ERROR", format([[Failed to load data module "%s". Reason: %s]], module.AddonName, reason and _G["ADDON_" .. reason] or "Unknown"))
                    end
                end,
            },
        }
...
function Options:AddAvailableDataModule(module, order, update)
    ...
    DataModulesTab.args.Available.args[module.AddonName] = {
        name = Utils:ColorizeText(format(update and "%s (Update)" or "%s", string.gsub(module.Title, "LoreTeller Data %- ", "")), "|cFF00CCFF"),
        type = "group",
        order = order,
        args = {
            AddonName = MakeDescription("Addon Name", module.AddonName),
...
function Options:Initialize()
    ...
    AceConfig:RegisterOptionsTable("LoreTeller", self.table, "lt")
    AceConfigDialog:AddToBlizOptions("LoreTeller")
    for key, tab in Utils:Ordered(Options.table.args, SortAceConfigOptions) do
        if not tab.hidden and not tab.dialogHidden then
            AceConfigDialog:AddToBlizOptions("LoreTeller", type(tab.name) == "function" and tab.name() or tab.name, "LoreTeller", key)
        end
    end
    ...
    --AceConfigDialog:SetDefaultSize("LoreTeller", 640, 780) -- Let it be auto-sized
    AceConfigDialog:Open("LoreTeller", self.frame)
    self.frame:SetLayout("Fill")
    self.frame:Hide()

    -- Enable the frame to be closed with Escape key
    _G["LoreTellerOptions"] = self.frame.frame
    tinsert(UISpecialFrames, "LoreTellerOptions")
end
